  ...
  return (
    <div className='validity-page'>
      ...
      <ul className="list-disc list-inside text-gray-700 space-y-2">
        <li>Application Form 15A (filled and signed)</li>
        <li>Applicant’s Aadhaar Card</li>
        <li>Proof of Residence (Electricity Bill / Ration Card / Rent Agreement / Jamabandi)</li>
        <li>Passport-size Photographs (2 copies)</li>
        <li>Self-Declaration / Affidavit Form 3 & 17 (in some cases)</li>
        <li>Beneficiary Aadhar Card</li>
        <li>Beneficiary TC, Bonafide Certificate / Father School TC</li>
