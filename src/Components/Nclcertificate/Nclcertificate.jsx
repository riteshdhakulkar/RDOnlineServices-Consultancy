  ...
  return (
    <div className='nclcertificate-page'>
      ...
      <ul className="list-disc list-inside text-gray-700 space-y-2">
        ...
        <li>Proof of Residence (Electricity Bill / Ration Card / Rent Agreement /tax Receipt)</li>
        <li>Birth Certificate or School Leaving Certificate</li>
        <li>Parent’s Caste Certificate (if available)</li>
        <li>Passport-size Photographs (2 copies)</li>
        <li>Self-Declaration / Affidavit (in some cases)</li>
        <li>Beneficiary Aadhar Card</li>
        <li>Father/Grandfather/Beneficiary School Leaving Certificate</li>
        <li>3 Years Income Certificate</li>
        <li>Grandfather School Leaving Certificate, Before 1967 for OBC, SBC-1961, SC-1950, ST-1950, NT-1967</li>
      </ul>
